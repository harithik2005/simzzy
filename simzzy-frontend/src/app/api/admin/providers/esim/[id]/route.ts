...
import { setEsimProviderStatus } from 'simzzy-backend'
...
export async function PUT(req: NextRequest, ctx: { params: Promise<{ id: string }> }) {
  ...
  try {
    const provider = await setEsimProviderStatus(id, body.status as ProviderStatus, {
    ...
    console.error(`[PUT /api/admin/providers/esim/${id}]`, e)
